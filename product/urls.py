...
router.register('subcategory_product_fetch', SubCategoryProductFetchAPIView, basename='subcategory_product_fetch_api')
router.register('brand_product_fetch', BrandProductFetchAPIView, basename='brand_product_fetch_api')
